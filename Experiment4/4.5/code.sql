...
select e1.employee_name employee, e2.employee_name manager from employees e1 left join employees e2 on e1.manager_id=e2.employee_id;
select customer_name, product_name from customers c full outer join products p;
